...
const BeveragesMenu = () => {
  const Items = [
    { id: 1, name: 'Banana Smoothie', slug: 'banana-smoothie', img: '/images/banana.jpg' },
    { id: 2, name: 'Faluda', slug: 'faluda', img: '/images/faluda.jpg' },
    { id: 3, name: 'Chocolate Milkshakes', slug: 'chocolate-milkshakes', img: '/images/milkshake.jpg' },
    { id: 4, name: 'Mojito', slug: 'mojito', img: '/images/mojito.jpg' },
    { id: 5, name: 'Orange Juice', slug: 'orange-juice', img: '/images/orange.jpg' },
  ];
  ...
  return (
    <div className={styles.container}>
      <h1>Beverages</h1>
      <p>
      Quench your thirst and elevate your dining experience with our thoughtfully curated selection of beverages. Whether you’re in the mood for a refreshing drink to complement your meal or a cozy beverage to savor on its own, our menu has something for everyone.
