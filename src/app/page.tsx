      ...
      <section className="about-section" id="about">
        <div className="about-container">
          ...
          <div className="about-content">
            ...
            <p>
            Step into our restaurant, where passion for culinary excellence is at the heart of everything we do. From the moment you walk through our doors, you’ll be greeted by the inviting aroma of freshly prepared dishes made from the finest, locally sourced ingredients. Our menu is a celebration of global cuisines, thoughtfully crafted to bring together bold flavors, timeless traditions, and modern twists.
            ...
            With locations across the country and internationally recognized for our commitment to quality is more than just a meal—it’s a journey of taste, comfort, and culinary innovation. Visit us today, and let us make your dining experience extraordinary
            </p>
          </div>
        </div>
      </section>
