  ...
  return (
    <div className={styles.aboutContainer}> {/* Use CSS Module here */}
      <section className={styles.aboutIntro}>
        ...
        <p><center>Our story began in a quaint kitchen, where a shared passion for exceptional cuisine first took root. What started as a humble endeavor quickly blossomed into a journey of culinary discovery. From the first bite, it was clear that our dedication to quality and innovation would set us apart. Driven by a love for bringing people together through unforgettable meals, we embarked on a mission to create a dining experience that combines tradition with modern flair. Our menu reflects a careful selection of ingredients and flavors from around the world, prepared with artistry and precision.</center></p>
        ...
        <p><center>As we continue to grow, our commitment remains the same: to offer a warm and welcoming atmosphere where every meal is a celebration of taste and togetherness. Join us as we write the next chapter of our story, one delicious dish at a time.</center></p>
      </section>
